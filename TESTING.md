...
| S2        | Forum Moderation Tools                 | <mark>PASS</mark>     | 1. Admins should be able to view and manage all forum threads, posts, and user accounts.                    | - Extended the admin panel to include moderation features.                                                       |
|           |                                        |                       | 2. Admins should be able to edit, delete, or flag content for review.                                       | - Implemented edit, delete, and flag functionalities for content.                                                |
| S2        | Forum Creation and Setup               | <mark>PASS</mark>     | 1. Users should be able to create forum threads and posts in different categories (e.g., Game Discussion, Reviews). | - Designed and implemented forum threads and categories.                                                         |
